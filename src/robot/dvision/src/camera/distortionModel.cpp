...
{
    cout << "DistortionModel init" << endl;
    ...
    m_undistCameraMatrix = m_cameraMatrix.clone();
    m_undistCameraMatrix.at<double>(0, 2) += offsetX;
    m_undistCameraMatrix.at<double>(1, 2) += offsetY;
    ...
    initUndistortRectifyMap(m_cameraMatrix, m_distCoeff, Mat(), m_undistCameraMatrix, m_undistImageSize, CV_16SC2, m_map1, m_map2);
}

// TODO(MWX): calibrate all 14 parameters
...
static void saveCameraParams(Settings& s, Size& imageSize, Mat& cameraMatrix,
  ...
  if (s.flag) {
    ...
    if (s.useFisheye) {
      flagsStringStream << "flags:" << (s.flag & fisheye::CALIB_FIX_SKEW
                                            ? " +fix_skew"
                                            : "")
...
// }
//
// static bool runCalibration(CalibSettings &s, Size &imageSize, Mat
// &cameraMatrix,
//                            Mat &distCoeffs, vector<vector<Point2f>>
//                            imagePoints,
//                            vector<Mat> &rvecs, vector<Mat> &tvecs,
//                            vector<float> &reprojErrs, double &totalAvgErr) {
//   cameraMatrix = Mat::eye(3, 3, CV_64F);
//   if (s.getFlag() & CALIB_FIX_ASPECT_RATIO) cameraMatrix.at<double>(0, 0) =
//   1.0;
//
//   distCoeffs = Mat::zeros(8, 1, CV_64F);
//
//   vector<vector<Point3f>> objectPoints(1);
//   calcBoardCornerPositions(s.getBoardSize(), s.getSquareSize(),
//   objectPoints[0],
//                            s.getCalibMode());
//
//   objectPoints.resize(imagePoints.size(), objectPoints[0]);
...
// }
//
// bool runCalibrationAndSave(CalibSettings &s, Size imageSize, Mat
// &cameraMatrix,
//                            Mat &distCoeffs,
//                            vector<vector<Point2f>> imagePoints) {
//   vector<Mat> rvecs, tvecs;
...
//   "/home/yyj/ZJUDancer/imageProcess/cv_test2/build/";
...
//   }
//
//   cout << foundCornerNum << " of " << imagesNum << " found corner
//   successfully!"
//        << endl;

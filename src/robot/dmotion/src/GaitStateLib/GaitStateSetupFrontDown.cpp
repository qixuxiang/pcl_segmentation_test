...
#include <sstream>
using namespace std;
GaitStateSetupFrontDown::GaitStateSetupFrontDown(I_HumanRobot* robot, GaitStateManager* manager)
  : GaitStateBase(SETUPFRONTDOWN, robot)
  , manager(manager)
{
...
void
GaitStateSetupFrontDown::execute()
{
    robot->doCrouchFromStand(30);
}

void
GaitStateSetupFrontDown::exit()
{
